...
from backend.models.balance import AccountBalance
...
class Account(Base):
    ...
    transactions: List[Mapped["Transaction"]] = relationship(back_populates="account", cascade="all, delete-orphan") 
    balances: List[Mapped["AccountBalance"]] = relationship(back_populates="account", cascade="all, delete-orphan")
